...
{
    AZ_COMPONENT_IMPL(FirstPersonControllerEditorSystemComponent, "FirstPersonControllerEditorSystemComponent",
        FirstPersonControllerEditorSystemComponentTypeId, BaseSystemComponent);
